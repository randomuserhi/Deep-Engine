...
namespace Deep {
    ...
    Quat Quat::FromMat4(Mat4Arg m) {
        ...
        if (trace >= 0.0f) {
            ...
            float is = 0.5f / s;
            return Quat((m.m12 - m.m21) * is, (m.m20 - m.m02) * is, (m.m01 - m.m10) * is, 0.5f * s);
        } else {
            int i = 0;
            if (m.m11 > m.m00) i = 1;
            ...
            if (i == 0) {
                ...
                float is = 0.5f / s;
                return Quat(0.5f * s, (m.m10 + m.m01) * is, (m.m02 + m.m20) * is, (m.m12 - m.m21) * is);
            } else if (i == 1) {
                float s = sqrt(m.m11 - (m.m22 + m.m00) + 1);
                float is = 0.5f / s;
                return Quat((m.m10 + m.m01) * is, 0.5f * s, (m.m21 + m.m12) * is, (m.m20 - m.m02) * is);
            } else {
                Deep_Assert(i == 2, "Index should be 2.");

                float s = sqrt(m.m22 - (m.m00 + m.m11) + 1);
                float is = 0.5f / s;
                return Quat((m.m02 + m.m20) * is, (m.m21 + m.m12) * is, 0.5f * s, (m.m01 - m.m10) * is);
            }
        }
    }
    ...
    Quat& Quat::Conjugate() {
        ...
        sse_m128 = SSE_m128::Xor(
            sse_m128, SSE_m128i{ (int32)0x80000000, (int32)0x80000000, (int32)0x80000000, 0 }.ReinterpretAsFloat());
        return *this;
    }
