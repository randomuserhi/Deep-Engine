...
namespace Deep {
    Mat4::Mat4(SSE_m128 col0, SSE_m128 col1, SSE_m128 col2, SSE_m128 col3) :
    ...
    Mat4 Mat4::FromQuaternion(const Quat& q) {
        ...
        __m128 plus =
            _mm_add_ps(_mm_mul_ps(two_xyzw, zxyw), _mm_mul_ps(two_yzxw, wwww)); // 2 * (xz + yw, xy + zw, yz + xw, ww)
        __m128 minus =
            _mm_sub_ps(_mm_mul_ps(two_yzxw, xyzw), _mm_mul_ps(two_zxyw, wwww)); // 2 * (xy - zw, yz - xw, xz - yw, 0)
    ...
    Mat4 Mat4::inversed() const {
        ...
        Mat4 result{ SSE_m128{ m11 * n22333223 - m21 * n12333213 + m31 * n12232213,
                               -m01 * n22333223 + m21 * n02333203 - m31 * n02232203,
                               m01 * n12333213 - m11 * n02333203 + m31 * n02131203,
                               -m01 * n12232213 + m11 * n02232203 - m21 * n02131203 },
                     SSE_m128{ -m10 * n22333223 + m20 * n12333213 - m30 * n12232213,
                               m00 * n22333223 - m20 * n02333203 + m30 * n02232203,
                               -m00 * n12333213 + m10 * n02333203 - m30 * n02131203,
                               m00 * n12232213 - m10 * n02232203 + m20 * n02131203 },
                     SSE_m128{ m10 * n21333123 - m20 * n11333113 + m30 * n11232113,
                               -m00 * n21333123 + m20 * n01333103 - m30 * n01232103,
                               m00 * n11333113 - m10 * n01333103 + m30 * n01131103,
                               -m00 * n11232113 + m10 * n01232103 - m20 * n01131103 },
                     SSE_m128{ -m10 * n21323122 + m20 * n11323112 - m30 * n11222112,
                               m00 * n21323122 - m20 * n01323102 + m30 * n01222102,
    ...
    Mat4 operator*(Mat4Arg a, Mat4Arg b) {
        ...
        c.cols[0] =
            _mm_add_ps(c.cols[0], _mm_mul_ps(a.cols[1], _mm_shuffle_ps(b.cols[0], b.cols[0], _MM_SHUFFLE(1, 1, 1, 1))));
        c.cols[0] =
            _mm_add_ps(c.cols[0], _mm_mul_ps(a.cols[2], _mm_shuffle_ps(b.cols[0], b.cols[0], _MM_SHUFFLE(2, 2, 2, 2))));
        c.cols[0] =
            _mm_add_ps(c.cols[0], _mm_mul_ps(a.cols[3], _mm_shuffle_ps(b.cols[0], b.cols[0], _MM_SHUFFLE(3, 3, 3, 3))));

        c.cols[1] = _mm_mul_ps(a.cols[0], _mm_shuffle_ps(b.cols[1], b.cols[1], _MM_SHUFFLE(0, 0, 0, 0)));
        c.cols[1] =
            _mm_add_ps(c.cols[1], _mm_mul_ps(a.cols[1], _mm_shuffle_ps(b.cols[1], b.cols[1], _MM_SHUFFLE(1, 1, 1, 1))));
        c.cols[1] =
            _mm_add_ps(c.cols[1], _mm_mul_ps(a.cols[2], _mm_shuffle_ps(b.cols[1], b.cols[1], _MM_SHUFFLE(2, 2, 2, 2))));
        c.cols[1] =
            _mm_add_ps(c.cols[1], _mm_mul_ps(a.cols[3], _mm_shuffle_ps(b.cols[1], b.cols[1], _MM_SHUFFLE(3, 3, 3, 3))));

        c.cols[2] = _mm_mul_ps(a.cols[0], _mm_shuffle_ps(b.cols[2], b.cols[2], _MM_SHUFFLE(0, 0, 0, 0)));
        c.cols[2] =
            _mm_add_ps(c.cols[2], _mm_mul_ps(a.cols[1], _mm_shuffle_ps(b.cols[2], b.cols[2], _MM_SHUFFLE(1, 1, 1, 1))));
        c.cols[2] =
            _mm_add_ps(c.cols[2], _mm_mul_ps(a.cols[2], _mm_shuffle_ps(b.cols[2], b.cols[2], _MM_SHUFFLE(2, 2, 2, 2))));
        c.cols[2] =
            _mm_add_ps(c.cols[2], _mm_mul_ps(a.cols[3], _mm_shuffle_ps(b.cols[2], b.cols[2], _MM_SHUFFLE(3, 3, 3, 3))));

        c.cols[3] = _mm_mul_ps(a.cols[0], _mm_shuffle_ps(b.cols[3], b.cols[3], _MM_SHUFFLE(0, 0, 0, 0)));
        c.cols[3] =
            _mm_add_ps(c.cols[3], _mm_mul_ps(a.cols[1], _mm_shuffle_ps(b.cols[3], b.cols[3], _MM_SHUFFLE(1, 1, 1, 1))));
        c.cols[3] =
            _mm_add_ps(c.cols[3], _mm_mul_ps(a.cols[2], _mm_shuffle_ps(b.cols[3], b.cols[3], _MM_SHUFFLE(2, 2, 2, 2))));
        c.cols[3] =
            _mm_add_ps(c.cols[3], _mm_mul_ps(a.cols[3], _mm_shuffle_ps(b.cols[3], b.cols[3], _MM_SHUFFLE(3, 3, 3, 3))));
#else
    ...
    Vec3 operator*(Mat4Arg m, Vec3Arg v) {
        ...
        _v.sse_m128 =
            _mm_add_ps(_v.sse_m128, _mm_mul_ps(m.cols[1], _mm_shuffle_ps(v.sse_m128, v.sse_m128, _MM_SHUFFLE(1, 1, 1, 1))));
        _v.sse_m128 =
            _mm_add_ps(_v.sse_m128, _mm_mul_ps(m.cols[2], _mm_shuffle_ps(v.sse_m128, v.sse_m128, _MM_SHUFFLE(2, 2, 2, 2))));
    ...
    Vec4 operator*(Mat4Arg m, Vec4Arg v) {
        ...
        _v.sse_m128 =
            _mm_add_ps(_v.sse_m128, _mm_mul_ps(m.cols[2], _mm_shuffle_ps(v.sse_m128, v.sse_m128, _MM_SHUFFLE(2, 2, 2, 2))));
        _v.sse_m128 =
            _mm_add_ps(_v.sse_m128, _mm_mul_ps(m.cols[3], _mm_shuffle_ps(v.sse_m128, v.sse_m128, _MM_SHUFFLE(3, 3, 3, 3))));
#else
