...
namespace Deep {
    ...
    SSE_m128::SSE_m128(Type _internal) :
        _internal(_internal) {}
...
#else
        return SSE_m128{ value, value, value, value };
#endif
    }
...
#else
        return SSE_m128i{ a.x == b.x ? (int32)0xffffffff : 0, a.y == b.y ? (int32)0xffffffff : 0,
                          a.z == b.z ? (int32)0xffffffff : 0, a.w == b.w ? (int32)0xffffffff : 0 };
#endif
    }
    ...
    SSE_m128 operator-(SSE_m128Arg a) {
        ...
        return SSE_m128{ 0.0f - a.x, 0.0f - a.y, 0.0f - a.z, 0.0f - a.w };
#endif
    }
...
#else
        return SSE_m128{ a * v.x, a * v.y, a * v.z, a * v.w };
#endif
    }
...
#else
        return SSE_m128{ control.x ? b.x : a.x, control.y ? b.y : a.y, control.z ? b.z : a.z, control.w ? b.w : a.w };
#endif
    }
    ...
    void SSE_m128::SinCos(SSE_m128& woSin, SSE_m128& woCos) {
        ...
        x = ((x - floatQuadrant * 1.5703125f) - floatQuadrant * 0.0004837512969970703125f)
        ...
        SSE_m128 taylorSin =
            ((-1.9515295891e-4f * x2 + SSE_m128::Replicate(8.3321608736e-3f)) * x2 - SSE_m128::Replicate(1.6666654611e-1f))
                * x2 * x
            + x;
